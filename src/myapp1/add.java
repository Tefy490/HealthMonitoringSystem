...
public class add extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Patient's status");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(Temperature, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(Status)
                    .addComponent(Patientsid, javax.swing.GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(Patientsid, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(58, 58, 58)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButton1)
                    .addComponent(jButton3)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     if (Patientsid.getText().isEmpty()|| Firstname.getText().isEmpty()|| last_name.getText().isEmpty()|| Status.getText().isEmpty()|| Temperature.getText().isEmpty())
     {
     ...
     else
     {
        ...
        try {
                ...
                preparedStatement.setString(1,Patientsid.getText());
                preparedStatement.setString(2,Firstname.getText());
                preparedStatement.setString(3,middle_name.getText());
                preparedStatement.setString(4,last_name.getText());
                preparedStatement.setString(5,Status.getText());
                preparedStatement.setString(6,Temperature.getText());
...
//Executing Query
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if(Patientsid.getText().isEmpty())
        {
            JOptionPane.showMessageDialog(null, "ENTER THE PATIENT TO BE DELETED");
        ...
        else
        {
            ...
            try{
 Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/HMS", "root", "F$48469star");//Establishing connection
     String Pid = Patientsid.getText();
     String Query = "Delete from HMS.patients WHERE patients_ID =" + Pid;
